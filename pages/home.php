...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" id="hero">
  ...
  <div class="absolute inset-0"
       style="background:linear-gradient(to bottom,rgba(42,25,10,.40) 0%,rgba(42,25,10,.18) 40%,rgba(250,246,240,.95) 100%);"></div>

  <div class="relative z-10 text-center px-6 py-10 sm:py-14 max-w-2xl mx-auto rounded-[2rem] border border-white/60 shadow-xl bg-white/75 backdrop-blur-md">
    <div class="reveal">
    ...
    <h1 class="reveal reveal-delay-1" style="font-family:'Playfair Display',serif;font-size:clamp(2.75rem,8vw,4.5rem);color:#2D1E15;line-height:1.1;margin-bottom:1.25rem;">
      Neko &amp; <span style="color:#4A6E56;font-style:italic;">Kopi</span>
    </h1>
    <p class="reveal reveal-delay-2" style="font-family:'Nunito',sans-serif;font-size:1.025rem;color:#4A382A;max-width:480px;margin:0 auto 2.25rem;line-height:1.65;font-weight:500;">
    ...
    <div class="reveal reveal-delay-3 flex flex-wrap justify-center gap-3">
      ...
      <a href="https://maps.google.com/?q=319/4+Nawala+Rd+Colombo+00500+Sri+Lanka"
         id="hero-cta-maps" target="_blank" rel="noopener" class="btn-outline">
        <i data-lucide="map-pin" class="w-4 h-4"></i>
        Visit Us
      </a>
      <a href="https://www.ubereats.com"
         id="hero-cta-uber" target="_blank" rel="noopener" class="btn-amber">
  ...
  <div class="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 animate-bounce"
    ...
    <span style="font-family:'Nunito',sans-serif;font-size:0.65rem;letter-spacing:0.15em;text-transform:uppercase;">Scroll</span>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="card overflow-hidden reveal reveal-delay-<?=$i+1?>">
        <div class="h-52 overflow-hidden">
          <img src="<?=$base?>/assets/images/<?=$h['img']?>"
               alt="<?=$h['h']?>"
        ...
        <div class="p-6">
          ...
          <h3 style="font-family:'Playfair Display',serif;font-size:1.2rem;color:#3A2A1E;margin-bottom:0.5rem;"><?=$h['h']?></h3>
          <p style="font-family:'Nunito',sans-serif;font-size:0.875rem;color:#8B6850;line-height:1.65;"><?=$h['p']?></p>
        </div>
      </div>
      <?php endforeach; ?>
  ...
  <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
    ...
    <div class="reveal order-2 lg:order-1 relative">
      <div class="rounded-3xl overflow-hidden" style="box-shadow:0 12px 48px rgba(90,50,20,0.14);">
        <img src="<?=$base?>/assets/images/hero.png"
             alt="The cozy interior of Neko & Kopi"
      ...
      <div class="absolute -bottom-5 -right-5 hidden md:flex flex-col items-center gap-1 rounded-2xl p-4"
        ...
        <span style="font-family:'Playfair Display',serif;font-size:0.8rem;font-weight:500;white-space:nowrap;">Cat Approved</span>
      </div>
    </div>
    ...
    <div class="reveal reveal-delay-2 order-1 lg:order-2 flex flex-col gap-5">
      ...
      <p class="section-subheading">
        Neko &amp; Kopi was born from a simple dream: to create a space where people could pause, breathe, and feel truly at home. Nestled on Nawala Road, we blend artisan coffee culture with the calming presence of cats.
      </p>
      <p class="section-subheading">
        We believe the best moments happen slowly — over a warm cup, a good book, and a cat curled up beside you. Whether you're working, creating, or simply resting, this is your corner of calm.
      </p>
...
<section class="section-pad" style="background:#FBFBFA;" id="featured">
  <div class="max-w-6xl mx-auto">
    <div class="text-center mb-14 reveal">
      ...
      <p class="section-subheading mx-auto mt-4">Each drink is a small story — crafted with seasonal ingredients and served with care.</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      <?php $drinks = [
        ['name'=>'Neko Latte',    'desc'=>'Signature house latte with cat paw art, a hint of vanilla & oat milk.','price'=>'Rs. 590','icon'=>'coffee','tag'=>'Best Seller'],
        ['name'=>'Sakura Chai',   'desc'=>'Ceylon black tea with rose, cardamom & steamed milk.','price'=>'Rs. 520','icon'=>'leaf','tag'=>'Fan Favourite'],
        ['name'=>'Forest Matcha', 'desc'=>'Ceremonial matcha with coconut milk, honey & black sesame.','price'=>'Rs. 650','icon'=>'sprout','tag'=>'Signature'],
      ...
      <div class="card p-6 flex flex-col gap-4 reveal reveal-delay-<?=$i+1?>">
        ...
        <div>
          <h3 style="font-family:'Playfair Display',serif;font-size:1.15rem;color:#3A2A1E;margin-bottom:0.35rem;"><?=$d['name']?></h3>
          <p style="font-family:'Nunito',sans-serif;font-size:0.85rem;color:#8B6850;line-height:1.6;"><?=$d['desc']?></p>
        </div>
        <div class="flex items-center justify-between mt-auto pt-4"
             style="border-top:1px solid rgba(196,149,106,0.18);">
          <span style="font-family:'Playfair Display',serif;font-size:1.1rem;color:#A07850;font-weight:600;"><?=$d['price']?></span>
...
<section class="section-pad" style="background:#FFFFFF;" id="events-teaser">
  <div class="max-w-6xl mx-auto">
    <div class="rounded-3xl overflow-hidden reveal"
         style="background:linear-gradient(135deg,#7A9E7E 0%,#4E7856 100%);">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
        <div class="p-10 md:p-14 flex flex-col gap-5 justify-center">
          ...
          <h2 style="font-family:'Playfair Display',serif;font-size:clamp(1.6rem,4vw,2.4rem);color:#fff;line-height:1.2;">
            Something's Always Happening
          </h2>
          <p style="font-family:'Nunito',sans-serif;font-size:0.9rem;color:rgba(255,255,255,0.80);line-height:1.7;max-width:380px;">
            Cat adoption days, live acoustic evenings, art workshops — there's always a warm reason to visit Neko &amp; Kopi.
          </p>
        ...
        <div class="hidden md:block relative overflow-hidden min-h-[280px]">
          <img src="<?=$base?>/assets/images/cats.png"
               alt="Live events at Neko & Kopi"
...
<section class="section-pad" style="background:#FBFBFA;" id="find-us">
  <div class="max-w-3xl mx-auto text-center reveal">
    ...
    <p style="font-family:'Nunito',sans-serif;font-size:0.9rem;color:#A07850;margin-bottom:2.5rem;">
      Open daily &middot; 9:00 AM – 9:00 PM
    </p>
    <div class="flex flex-wrap justify-center gap-3">
      <a href="https://maps.google.com/?q=319/4+Nawala+Rd+Colombo+00500"
         id="find-us-maps" target="_blank" rel="noopener" class="btn-primary">
        <i data-lucide="map-pin" class="w-4 h-4"></i>
        Open in Maps
      </a>
      <a href="https://wa.me/94724783406?text=Hello%20Neko%20%26%20Kopi!"
         id="find-us-whatsapp" target="_blank" rel="noopener" class="btn-whatsapp">
