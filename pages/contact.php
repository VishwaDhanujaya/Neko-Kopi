      ...
      <div class="card p-6 reveal reveal-delay-2">
        ...
        <div class="grid grid-cols-3 gap-2">
          <a href="https://instagram.com" id="contact-instagram" target="_blank" rel="noopener"
             class="flex flex-col items-center gap-1.5 py-3 rounded-xl hover:bg-cream-dark transition-colors duration-200" style="background:#F5EFE6;">
            <i data-lucide="instagram" class="w-5 h-5 text-brown"></i>
          ...
          <a href="https://tiktok.com" id="contact-tiktok" target="_blank" rel="noopener"
             class="flex flex-col items-center gap-1.5 py-3 rounded-xl hover:bg-cream-dark transition-colors duration-200" style="background:#F5EFE6;">
            <i data-lucide="smartphone" class="w-5 h-5 text-brown"></i>
          ...
          <a href="https://facebook.com" id="contact-facebook" target="_blank" rel="noopener"
             class="flex flex-col items-center gap-1.5 py-3 rounded-xl hover:bg-cream-dark transition-colors duration-200" style="background:#F5EFE6;">
            <i data-lucide="facebook" class="w-5 h-5 text-brown"></i>
