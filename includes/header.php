...
<head>
  ...
  <meta name="description" content="<?= $pageDesc ?? 'Neko &amp; Kopi is Colombo\'s most cozy cat café — a warm, Ghibli-inspired sanctuary with artisan coffee, resident cats, and a home-like creative atmosphere.' ?>">
  <meta name="keywords"    content="cat café Colombo, Neko Kopi, cozy café Sri Lanka, artisan coffee Nawala, cat adoption Colombo">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Nunito:wght@400;500;600;700;800&display=swap" rel="stylesheet">
...
<header id="navbar" class="nav-glass fixed top-0 left-0 right-0 z-50">
  <nav class="max-w-6xl mx-auto px-5 sm:px-8 h-[62px] flex items-center justify-between gap-6">
    ...
    <!-- Logo -->
    <a href="<?= $base ?>/pages/home.php" id="logo-link"
       class="flex items-center gap-2.5 group flex-shrink-0">
      <img src="<?= $base ?>/assets/images/logo.png" alt="Neko &amp; Kopi" class="w-9 h-9 rounded-full object-cover border border-black/5 shadow-sm transition-transform duration-300 group-hover:scale-105">
      <span class="font-serif text-base tracking-tight font-semibold" style="color:#2C1E15;">Neko &amp; <span style="color:#72987C;">Kopi</span></span>
    </a>
    ...
    <button id="menu-btn"
            ...
            class="md:hidden p-1.5 rounded-lg transition-colors duration-200"
            style="color:#7A5533;">
  ...
  <div id="mobile-menu" role="navigation" aria-label="Mobile navigation">
    <div class="max-w-6xl mx-auto px-5 sm:px-8 pb-4 pt-2 flex flex-col gap-0.5"
      ...
      ?>
        <a href="<?= $href ?>"
           id="mobile-nav-<?= $key ?>"
           class="py-2.5 text-sm font-semibold border-b transition-colors duration-200"
      ...
      <a href="<?= $base ?>/pages/menu.php"
         id="mobile-nav-cta"
         class="btn-primary mt-3 justify-center">
